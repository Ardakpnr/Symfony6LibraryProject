...
class Setting
{
    ...
    #[ORM\Column(length: 255, nullable: true)]
    private ?string $desceription = null;
    ...
    public function getDesceription(): ?string
    {
        return $this->desceription;
    }

    public function setDesceription(string $desceription): self
    {
    ...
    public function getInstegram(): ?string
    {
        return $this->instegram;
    }

    public function setInstegram(string $instegram): self
    {
