 ...
 */
final class Version20220912143709 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE setting (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(150) NOT NULL, keywords VARCHAR(255) NOT NULL, desceription VARCHAR(255) NOT NULL, company VARCHAR(100) NOT NULL, adress VARCHAR(255) NOT NULL, phone VARCHAR(15) NOT NULL, fax VARCHAR(14) NOT NULL, email VARCHAR(50) NOT NULL, smtpserver VARCHAR(100) DEFAULT NULL, smtpemail VARCHAR(50) DEFAULT NULL, smtppassword VARCHAR(10) DEFAULT NULL, smtpport INT DEFAULT NULL, facebook VARCHAR(100) DEFAULT NULL, instegram VARCHAR(100) NOT NULL, twitter VARCHAR(100) DEFAULT NULL, youtube VARCHAR(100) DEFAULT NULL, tiktok VARCHAR(100) DEFAULT NULL, aboutus LONGTEXT DEFAULT NULL, contact LONGTEXT DEFAULT NULL, reference LONGTEXT DEFAULT NULL, status VARCHAR(6) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE image DROP FOREIGN KEY FK_C53D045F4584665A');
        $this->addSql('DROP INDEX IDX_C53D045F4584665A ON image');
        $this->addSql('ALTER TABLE image CHANGE product_id product_id VARCHAR(100) DEFAULT NULL');
    }
